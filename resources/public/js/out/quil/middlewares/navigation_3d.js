...
var vec__28257 = axis;
var a_x = cljs.core.nth.call(null,vec__28257,(0),null);
var a_y = cljs.core.nth.call(null,vec__28257,(1),null);
var a_z = cljs.core.nth.call(null,vec__28257,(2),null);
var vec__28260 = v;
var x = cljs.core.nth.call(null,vec__28260,(0),null);
var y = cljs.core.nth.call(null,vec__28260,(1),null);
var z = cljs.core.nth.call(null,vec__28260,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__28263,p__28264){
var vec__28271 = p__28263;
var u1 = cljs.core.nth.call(null,vec__28271,(0),null);
var u2 = cljs.core.nth.call(null,vec__28271,(1),null);
var u3 = cljs.core.nth.call(null,vec__28271,(2),null);
var vec__28274 = p__28264;
var v1 = cljs.core.nth.call(null,vec__28274,(0),null);
var v2 = cljs.core.nth.call(null,vec__28274,(1),null);
var v3 = cljs.core.nth.call(null,vec__28274,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__28277_SHARP_){
return (p1__28277_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__28278_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__28279_SHARP_,angle_lr),angle_ud);
...
var map__28286 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__28286__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__28286__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__28288 = cljs.core._EQ_;
var expr__28289 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__28288.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__28289))){
return straight;
} else {
if(cljs.core.truth_(pred__28288.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__28289))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__28288.call(null,quil.middlewares.navigation_3d.space,expr__28289))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__28288.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__28289))){
return up;
} else {
if(cljs.core.truth_(pred__28288.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__28289))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__28288.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__28289))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__28286,map__28286__$1,up,straight){
return (function (p1__28280_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__28280_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__28286,map__28286__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__28291_SHARP_);
});})(initial_state))
);
});
/**
...
var map__28303_28314 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__28303_28315__$1 = ((((!((map__28303_28314 == null)))?((((map__28303_28314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28303_28314.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28303_28314):map__28303_28314);
var vec__28304_28316 = cljs.core.get.call(null,map__28303_28315__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_28317 = cljs.core.nth.call(null,vec__28304_28316,(0),null);
var c_y_28318 = cljs.core.nth.call(null,vec__28304_28316,(1),null);
var c_z_28319 = cljs.core.nth.call(null,vec__28304_28316,(2),null);
var vec__28307_28320 = cljs.core.get.call(null,map__28303_28315__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_28321 = cljs.core.nth.call(null,vec__28307_28320,(0),null);
var u_y_28322 = cljs.core.nth.call(null,vec__28307_28320,(1),null);
var u_z_28323 = cljs.core.nth.call(null,vec__28307_28320,(2),null);
var vec__28310_28324 = cljs.core.get.call(null,map__28303_28315__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_28325 = cljs.core.nth.call(null,vec__28310_28324,(0),null);
var p_y_28326 = cljs.core.nth.call(null,vec__28310_28324,(1),null);
var p_z_28327 = cljs.core.nth.call(null,vec__28310_28324,(2),null);
quil.core.camera.call(null,p_x_28325,p_y_28326,p_z_28327,(p_x_28325 + c_x_28317),(p_y_28326 + c_y_28318),(p_z_28327 + c_z_28319),u_x_28321,u_y_28322,u_z_28323);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1489246394318