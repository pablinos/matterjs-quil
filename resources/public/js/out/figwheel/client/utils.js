...
return (new CustomEvent(event_name,(function (){var obj33491 = {"detail":data};
return obj33491;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25204__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25204__auto__)){
var and__25204__auto____$1 = (window["CustomEvent"]);
...
var args33496 = [];
var len__26329__auto___33502 = arguments.length;
var i__26330__auto___33503 = (0);
while(true){
if((i__26330__auto___33503 < len__26329__auto___33502)){
args33496.push((arguments[i__26330__auto___33503]));

var G__33504 = (i__26330__auto___33503 + (1));
i__26330__auto___33503 = G__33504;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33496.length)].join('')));
...
var f = (function (){var pred__33499 = cljs.core._EQ_;
var expr__33500 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33499.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33500))){
return ((function (pred__33499,expr__33500){
return (function (p1__33492_SHARP_){
return console.warn(p1__33492_SHARP_);
});
;})(pred__33499,expr__33500))
} else {
if(cljs.core.truth_(pred__33499.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33500))){
return ((function (pred__33499,expr__33500){
return (function (p1__33493_SHARP_){
return console.debug(p1__33493_SHARP_);
});
;})(pred__33499,expr__33500))
} else {
if(cljs.core.truth_(pred__33499.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33500))){
return ((function (pred__33499,expr__33500){
return (function (p1__33494_SHARP_){
return console.error(p1__33494_SHARP_);
});
;})(pred__33499,expr__33500))
} else {
return ((function (pred__33499,expr__33500){
return (function (p1__33495_SHARP_){
return console.log(p1__33495_SHARP_);
});
;})(pred__33499,expr__33500))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33506){
var map__33509 = p__33506;
...
var eval_fn = cljs.core.get.call(null,map__33509__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33511_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33513,(0),null);
...
var args33516 = [];
var len__26329__auto___33519 = arguments.length;
var i__26330__auto___33520 = (0);
while(true){
if((i__26330__auto___33520 < len__26329__auto___33519)){
args33516.push((arguments[i__26330__auto___33520]));

var G__33521 = (i__26330__auto___33520 + (1));
i__26330__auto___33520 = G__33521;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33516.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25204__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1489246402674